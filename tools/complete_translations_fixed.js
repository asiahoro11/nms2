    ...
    'en-US.json': {
        ...
        devices: {
            toast: {
                ...
                poe_action_sent: "PoE \x7Baction\x7D command sent",
        ...
        topology: {
            toast: {
                ...
                select_source: "Source device selected: \x7Bname\x7D, please click target device",
                ...
                link_info: "Link: {source} ↔ \x7Btarget\x7D",
    ...
    'zh-CN.json': {
        ...
        devices: {
            toast: {
                ...
                backup_failed: "备份失败",
                poe_action_sent: "PoE \x7Baction\x7D 指令已发送",
        ...
        topology: {
            toast: {
                ...
                select_source: "已选择来源设备: \x7Bname\x7D，请点击目标设备",
                ...
                link_info: "连线: {source} ↔ \x7Btarget\x7D",
                                            ...
                                            reboot_failed: "再起動に失敗しました",
                                                backup_sent: "設定保存コマンドが送信されました",
                                                    backup_failed: "バックアップに失敗しました",
                                                        poe_action_sent: "PoE \x7Baction\x7D コマンドが送信されました",
            ...
            load_failed: "トポロジーデータの読み込みに失敗しました",
                device_placed: "デバイスが配置されました",
                    update_position_failed: "デバイスの位置を更新できませんでした",
                        select_source: "ソースデバイスを選択しました: \x7Bname\x7D、ターゲットデバイスをクリックしてください",
                                        ...
                                        reboot_sent: "재부팅 명령이 전송되었습니다",
                                            reboot_failed: "재부팅 실패",
                                                backup_sent: "구성 저장 명령이 전송되었습니다",
                                                    backup_failed: "백업 실패",
                                                        poe_action_sent: "PoE \x7Baction\x7D 명령이 전송되었습니다",
            ...
            load_failed: "토폴로지 데이터 로드 실패",
                device_placed: "장치가 배치되었습니다",
                    update_position_failed: "장치 위치를 업데이트할 수 없습니다",
                        select_source: "소스 장치 선택됨: \x7Bname\x7D, 대상 장치를 클릭하세요",
                                                            ...
                                                            save_positions_failed: "위치 저장 실패",
                                                                discovery_started: "토폴로지 검색이 시작되었습니다",
                                                                    discovery_failed: "토폴로지 검색 시작 실패",
                                                                        link_info: "링크: {source} ↔ \x7Btarget\x7D",
